...
import com.example.springsecurity.config.Response.JwtResponse;
import com.example.springsecurity.config.Response.LoginRequest;
import com.example.springsecurity.config.Response.MessageResponse;
import com.example.springsecurity.config.Response.SignupRequest;
...
import com.example.springsecurity.config.repo.RoleRepository;
...
public class AuthController{
    ...
    public ResponseEntity<?> registerUser( @RequestBody SignupRequest signUpRequest) {
       ...
       SpringUser user = new SpringUser(signUpRequest.getUsername(),
